...
<head>
    ...
    <title>Sik51 Spamer | Log in</title>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{ cxl_asset('backend/plugins/iCheck/square/blue.css') }}">
    ...
    <div class="login-box-body">
        ...
        <form id="login-form" action="{{ route('login.submit') }}" method="post">
            ...
            <div class="form-group has-feedback">
                <input id="username" type="text" class="form-control form-control-login{{ $errors->has('username') ? ' is-invalid' : '' }}" name="username" value="{{ old('username') }}" placeholder="Username..">
            ...
            <div class="form-group has-feedback @if ($errors->any()) has-error @endif ">
                <input id="password" type="password" class="form-control form-control-login{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" placeholder="Password..">
...
<!-- iCheck -->
<script src="{{ cxl_asset('backend/plugins/iCheck/icheck.min.js') }}"></script>
<script>
    $(function () {
        $('input').iCheck({
